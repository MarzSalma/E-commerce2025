...
<html lang="en">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Liste des Boutiques</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Liste des Boutiques</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
  ...
  <div class="col-md-12">
    <div class="card mb-4 border">
      <div class="card-header"><h3 class="card-title">Liste des Boutiques</h3></div>
      <!-- /.card-header -->
      <div class="card-body">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr class="align-middle">
              ...
              <td>
                <span class="badge text-bg-{{ $shop->status == 'actif' ? 'success' : 'danger' }}">
                  {{ ucfirst($shop->status) }}
                </span>
              </td>
              <td>{{ $shop->seller->name ?? 'N/A' }}</td> <!-- Afficher le nom du vendeur -->
              <td> <!-- Colonne des actions -->

              <a href="{{ route('shops.edit', $shop->id) }}" class="btn btn-success btn-sm">Modifier</a>

                <form action="{{ route('shops.destroy', $shop->id) }}" method="POST" style="display:inline;">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette boutique ?')">Supprimer</button>
  </form>
