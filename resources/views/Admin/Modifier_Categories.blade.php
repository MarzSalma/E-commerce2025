...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets2/css/adminlte.css') }}" />
...
@endif
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
          <div class="row">
              <div class="col-sm-6 d-flex justify-content-center"><h3 class="mb-0">Modifer Catégories :</h3></div>
              <div class="col-sm-6">
        ...
        <div class="card card-success card-outline mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nom de la catégorie" value="{{ old('name', $category->name) }}" required />
                    <div class="invalid-feedback">Le nom de la catégorie est obligatoire et doit être unique.</div>
                </div>

                <!-- Description de la catégorie -->
                <div class="mb-3">
                    <label for="description" class="form-label">Description de la catégorie</label>
                    <textarea class="form-control" id="description" name="description" placeholder="Description de la catégorie">{{ old('description', $category->description) }}</textarea>
                </div>

                <!-- Statut de la catégorie -->
                <div class="mb-3">
                    <label for="status" class="form-label">Statut de la catégorie</label>
                    <select class="form-select" id="status" name="status" required>
                        <option value="">Sélectionnez le statut</option>
                        <option value="actif" {{ old('status', $category->status) == 'actif' ? 'selected' : '' }}>Actif</option>
                        <option value="inactif" {{ old('status', $category->status) == 'inactif' ? 'selected' : '' }}>Inactif</option>
                    </select>
    ...
    <script src="{{ asset('assets2/js/adminlte.js') }}"></script>
