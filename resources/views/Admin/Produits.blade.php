...
<!--end::App Content-->
<!-- Bouton + à droite -->
<a href="/ajouter-produit" class="btn btn-success position-fixed" style="bottom: 20px; right: 20px; font-size: 30px; width: 60px; height: 60px; text-align: center; display: flex; justify-content: center; align-items: center; border-radius: 50%;">
  +
</a>
