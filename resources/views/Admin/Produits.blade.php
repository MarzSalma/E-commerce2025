          ...
          <a href="/produit/{{ $product->id }}" class="text-decoration-none">
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <a href="/produit/{{ $product->id }}" class="btn btn-primary">Voir Détails</a>
              </div>
            </div>
          </a>
        </div>
...
<!--end::App Content-->
<!-- Bouton + à droite -->
<a href="/Ajouter_Produit" class="btn btn-success position-fixed" style="bottom: 20px; right: 20px; font-size: 30px; width: 60px; height: 60px; text-align: center; display: flex; justify-content: center; align-items: center; border-radius: 50%;">
  +
</a>
