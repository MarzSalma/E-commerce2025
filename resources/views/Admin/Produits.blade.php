  ...
  <div class="app-content">
    ...
    <div class="container-fluid">
          ...
          <a href="/produit/{{ $product->id }}" class="text-decoration-none">
            <div class="card mb-4 shadow-sm" style="cursor: pointer;">
              ...
              <div class="card-body">
                ...
                <!-- The "Voir Détails" button is optional here since the whole card is clickable -->
              </div>
            </div>
          </a>
        </div>
      ...
      <div class="text-center mt-4">
        <a href="/Ajouter_Produit" class="btn btn-success btn-lg" style="border-radius: 50%; width: 60px; height: 60px; font-size: 30px; line-height: 50px; display: inline-flex; align-items: center; justify-content: center ; position: fixed;
  bottom: 60px;
  right: 20px;">
          +
        </a>
